document.getElementById("dateInput").addEventListener("change", (event) => {
  ...
  // Use shared state
  updateAppState({ date: selectedDate, dateSavedOn: todayStr });
...
const state = getAppState(); // From utils.js
const todayStr = new Date().toLocaleDateString('en-CA');

let initialDate = todayStr;

// Restore date if saved on same day
if (state.date && state.dateSavedOn === todayStr) {
