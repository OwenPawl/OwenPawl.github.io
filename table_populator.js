{
  const handleTableLoading = () => {
    ...
    // Also clear locations while loading
  ...
  function updateTable(schedule) {
    ...
    // --- RENDER LOCATION BADGES ---
    const locHeader = document.getElementById("locationHeader");
    if (locHeader) {
      locHeader.innerHTML = ""; // Clear previous
      
      // Filter out excluded IDs to prevent "incorrect" locations from showing
