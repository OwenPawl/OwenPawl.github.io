...
// Mappings for Pike13 naming variations
SKILLS["BABY (UNDER 12 MONTHS)"] = SKILLS["BABY (0-2 YEARS)"];
SKILLS["LEVEL 2 (UNDERWATER EXPLORER)"] = SKILLS["LEVEL 2 (UNDERWATER DISCOVERY)"];
SKILLS["LEVEL 6 (FINE TUNING & ENDURANCE)"] = SKILLS["LEVEL 6 (FINE TUNING)"];
